...
public class EditarPistaAlerta extends javax.swing.JFrame {
    int bandera = 0;
    List<String> niveles;
    
    public EditarPistaAlerta(int bandera) {
        initComponents();
        ...
        try {
            this.jLabel14.setText(Utils.today());
            this.jLabel15.setText(Utils.tomorrow());
        } catch (ParseException ex) {
            Logger.getLogger(EditarPistaAlerta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Detección:");

        jLabel9.setText("Servicio:");

        jLabel10.setText("Largo(mts):");

        jCheckBox1.setText("Negativo");
        ...
        jLabel11.setText("14QM576134");

        jLabel12.setText("4567");
        ...
        jLabel17.setText("Método de Destrucción:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel18.setText("Ancho(mts):");

        jLabel19.setText("Unidad:");

        jLabel3.setText("V R.M");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        new NegativoPista(0).setVisible(true);
        this.dispose();
