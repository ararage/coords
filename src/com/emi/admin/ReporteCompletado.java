...
public class ReporteCompletado extends javax.swing.JFrame {
    /*
    ...
    */
    private int perfil;
    public ReporteCompletado(int perfil, int tipo, int estatus) {
        initComponents();
        ...
        this.jLabel3.setText("12345");
        this.jLabel5.setText("1");
        this.jLabel7.setText("20");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        new VerCoordenada2().setVisible(true);
        this.dispose();
