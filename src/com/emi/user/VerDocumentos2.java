...
public class VerDocumentos2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("FCA: 42543");

        jLabel3.setText("Fecha: 5/may/2018");

        jButton2.setText("Coordenadas Plantios");
        ...
        jLabel4.setText("T.I.: S-1 (M-1)");

        jLabel5.setText("Editar:");

        jButton3.setText("Coordenadas Pistas");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new TablaPlantios(0).setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new TablaPistas(0).setVisible(true);
        this.dispose();
